          ...
          <div className="card" style={{ padding: '1.75rem', background: 'linear-gradient(135deg, rgba(34, 211, 238, 0.05), transparent)', border: '1px solid rgba(34, 211, 238, 0.2)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.78rem', color: 'var(--text-dim)' }}>Endpoint para captura de mensagens nos grupos administrados</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '1rem' }}>
              ...
              <button 
                ...
                onClick={() => handleCopy(webhookUrl, 'webhook_principal', 'URL do Webhook Principal copiada!')}
          ...
          <div className="card" style={{ padding: '1.75rem', background: 'linear-gradient(135deg, rgba(168, 85, 247, 0.05), transparent)', border: '1px solid rgba(168, 85, 247, 0.25)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.78rem', color: 'var(--text-dim)' }}>Endpoint para monitoramento de abordagens no privado do número fantasma</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '1rem' }}>
              <input 
                readOnly 
                value={webhookFantasmaUrl || webhookUrl?.replace('/whatsapp', '/fantasma')} 
              ...
              <button 
                className="btn btn-primary" 
                onClick={() => handleCopy(webhookFantasmaUrl || webhookUrl?.replace('/whatsapp', '/fantasma'), 'webhook_fantasma', 'URL do Webhook do Número Fantasma copiada!')}
